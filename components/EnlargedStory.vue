<template>
  <div class="fixed top-0 left-0 w-full h-full z-50 backdrop-brightness-50">
    <button @click="$emit('toggleEnlarged')" class="absolute top-0 right-0 p-4 z-50">
      <svg class="h-6 w-6 text-white" stroke="currentColor" fill="none" viewBox="0 0 24 24">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/>
      </svg>
    </button>
    
    <div class="my-auto mx-auto h-min absolute inset-0 flex flex-col md:flex-row justify-center">
