<template>
  <div class="mx-auto w-full max-w-xs rounded-lg bg-rose-500 text-white mt-16 py-4">
    ...
    <div class="my-4">
      <form class="text-xl px-4">
        ...
        <input v-model="email" class="shadow appearance-none border rounded w-full mb-4 py-1 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline bg-rose-100" required>
        <label class="block text-left mb-2" for="password">Password:</label>
        <input v-model="password" class="shadow appearance-none border rounded w-full mb-4 py-1 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline bg-rose-100" required>
        <button type="submit" class="text-center text-lg py-1 px-2 rounded bg-rose-600 hover:bg-rose-700 active:bg-rose-800">Sign Up</button>
      </form>
    </div>
  </div>
</template>
